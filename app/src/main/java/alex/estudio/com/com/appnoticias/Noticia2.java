...
public class Noticia2 extends AppCompatActivity implements View.OnClickListener{
    ...
    public int[] imagenes = {R.drawable.bentley1, R.drawable.bentley2, R.drawable.bentley3};
